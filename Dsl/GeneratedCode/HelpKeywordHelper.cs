...
namespace Company.DSLBootstrap
{
	...
	/// </remarks>
	public partial class DSLBootstrapHelpKeywordHelper : DSLBootstrapHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DSLBootstrapHelpKeywordHelper.
		/// </summary>
		protected DSLBootstrapHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DSLBootstrapHelpKeywordHelper.
		/// </summary>
		public static DSLBootstrapHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DSLBootstrapHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DSLBootstrapHelpKeywordHelperBase.
		/// </summary>
		protected DSLBootstrapHelpKeywordHelperBase()
			: base() { }
