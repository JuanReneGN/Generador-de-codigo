...
namespace Company.DSLBootstrap
{
	...
	/// </summary>
	internal partial class DSLBootstrapDocView : DSLBootstrapDocViewBase
	{
		/// <summary>
		/// Constructs a new DSLBootstrapDocView.
		/// </summary>
		public DSLBootstrapDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DSLBootstrapDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DSLBootstrapDocView.
		/// </summary>
		...
		protected override bool LoadView()
		{
			...
			DSLBootstrapDocDataBase docData = this.DocData as DSLBootstrapDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DSLBootstrapDocViewBase should be an DSLBootstrapDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.DSLBootstrap.DSLBootstrapDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.DSLBootstrap.DSLBootstrapDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.DSLBootstrap.DSLBootstrapToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.DSLBootstrap.DSLBootstrapToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DSLBootstrapDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.DSLBootstrap.DSLBootstrapHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.DSLBootstrap.DSLBootstrapHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.DSLBootstrap.DSLBootstrapHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
