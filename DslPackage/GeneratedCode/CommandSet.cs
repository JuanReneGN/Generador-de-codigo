...
namespace Company.DSLBootstrap
{
	...
	/// </summary>
	internal partial class DSLBootstrapCommandSet : DSLBootstrapCommandSetBase
	{
		/// <summary>
		/// Constructs a new DSLBootstrapCommandSet.
		/// </summary>
		public DSLBootstrapCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DSLBootstrapCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DSLBootstrapCommandSetBase.
		/// </summary>
		protected DSLBootstrapCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDSLBootstrapExplorerCommand,
				typeof(DSLBootstrapEditorFactory).GUID);
		...
		{
			DSLBootstrapExplorerToolWindow explorer = this.DSLBootstrapExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DSLBootstrapDocData CurrentDSLBootstrapDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DSLBootstrapDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DSLBootstrapDocView CurrentDSLBootstrapDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DSLBootstrapDocView;
			}
		}
		...
		/// </summary>
		protected DSLBootstrapExplorerToolWindow DSLBootstrapExplorerToolWindow
		{
			get
			{
				DSLBootstrapExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DSLBootstrapExplorerToolWindow), true) as DSLBootstrapExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DSLBootstrapExplorerToolWindow explorerWindow = this.DSLBootstrapExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DSLBootstrapClipboardCommandSet : DSLBootstrapClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DSLBootstrapClipboardCommandSet.
		/// </summary>
		public DSLBootstrapClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DSLBootstrapClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DSLBootstrapClipboardCommandSetBase.
		/// </summary>
		protected DSLBootstrapClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
