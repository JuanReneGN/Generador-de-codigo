...
namespace Company.DSLBootstrap
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.DSLBootstrapEditorFactoryId)]
	internal partial class DSLBootstrapEditorFactory : DSLBootstrapEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new DSLBootstrapEditorFactory.
		/// </summary>
		public DSLBootstrapEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DSLBootstrapEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected DSLBootstrapEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new DSLBootstrapDocData(this.ServiceProvider, typeof(DSLBootstrapEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new DSLBootstrapDocView(docData, this.ServiceProvider);
		}
	}
}
